...
elseif UserID == 1792413842 or UserID == 1420036323  then  
...
if UserID == 1792413842 or UserID == 1420036323then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 1792413842 or UserID == 1420036323then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
return '- اصدار سورس سبيد : *v'..version..'* '
end

if MsgText[1] == 'اصدار السورس' or MsgText[1] == 'الاصدار' then
return 'ঌ اصدار سورس سبيد*v'..version..'* \n'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request('https://raw.githubusercontent.com/iamspeedwhourhhhhhh/iamspeedwhourhhhhhh.github.io/main/GetVersion.txt') or "0"
...
sendMsg(arg.chat_id_,arg.id_,'- عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس سبيد يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم ')
end  
else
...
local inline = {{{text="قناه‏‏ السـورس : اباظـة ",url="t.me/jjxxh"}}}
send_key(msg.sender_user_id_,'  [قناة السورس: اباظـة](t.me/jjxxh)',nil,inline,msg.id_)
return false
end
...
if MsgText[1] == "joker"  then
local text = " اهلاً بك عزيزي"
local inline = {
{{text = '- 𝐃𝐄𝐕 ',url="https://t.me/UUOUOU_7"}},
}   
...
if MsgText[1] == "JOKER" then
local text = " [مطور السورس ](t.me/UUOUOU_7)"
local inline = {
{{text = '- 𝙳𝙴𝚅 ',url="https://t.me/UUOUOU_7"}},
}   
return send_inline(msg.chat_id_,text,inline,msg.id_)
end

if MsgText[1] == "السورس" or MsgText[1]=="سورس" then
local text = "𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 SPEED ⩫"
local inline = {
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 SPEED ⩫ ',url="https://t.me/jjxxh"}},
{{text = '- 𝘿𝙀𝙑 ',url="https://t.me/xb_1b"}},
{{text = '- 𝙏𝙒𝘼𝙎𝙊𝙇  ',url="https://t.me/JOK_ER_7bot"}},
}   
return send_inline(msg.chat_id_,text,inline,msg.id_)
end
...
if not msg.SudoBase then return "✦¹  هذا الامر يخص {المطور الاساسي} فقط  \n" end
local Get_Files, res = https.request("https://iamspeedwhourhhhhhh.github.io/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/iamspeedwhourhhhhhh/speed/main/plugins/"..FileName)
if res == 200 then
...
NameUser = Hyper_Link_Name(data)
if UserID == 1792413842 or UserID == 1420036323then 
...
if CheckUserinstall(arg.USERNAME) then return sendMsg(arg.ChatID,arg.MsgID,"- عذرا هذا الحساب محظور من سيرفرات حماية سبيد ") end
...
if msg.adduser == 1792413842 or msg.adduser ==  1420036323 then 
gtupe = 'مطور السورس' 
...
elseif Text== "الجوكر" or Text== "جوكر" or Text== "محمد" then return sendMsg(msg.chat_id_,msg.id_,"[ مطور السورس ](T.ME/UUOUOU_7)")
