...
if UserID == 656329268 or UserID == 1765160742 or UserID == 1714422669then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس \n") end
...
msg = arg.msg
if UserID == 656329268 or UserID == 1765160742 or UserID == 1714422669then return sendMsg(msg.chat_id_,msg.id_,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
NameUser = Hyper_Link_Name(data)
...
local video = redis:hget(boss..'https://t.me/abazahh/17',msg.text)
local inline = {
{{text = '𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝘽𝘼𝙕𝘼 ⩫ ',url="https://t.me/jjxxh"}},
{{text = '-𝘿𝙀𝙑   👑',url="https://t.me/xb_0b"}},
{{text = '-𝘿𝙀𝙑   👑',url="https://t.me/UUOUOU_7"}},
{{text = '-𝙏𝙒𝘼𝙎𝙊𝙇 💬 ',url="https://t.me/Abazaxbot"}},
}   
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/abazahh/17&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
